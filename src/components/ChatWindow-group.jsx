// components/ChatWindow-group.jsx
import React, { useState, useRef, useEffect } from "react";
import { ChevronLeft, ChevronRight } from "lucide-react";

const ChatWindowGroup = ({ onClose }) => {
      ...
      <div className="flex flex-1">
        {sidebarVisible ? (
          <div className="w-1/3 bg-gray-100 p-4">
            ...
            <div className="mt-4 space-y-2">
              <div className="p-2 bg-white rounded-xl shadow">Group Project 1</div>
              <div className="p-2 bg-white rounded-xl shadow">Group Project 2</div>
            </div>
          </div>
        ) : (
        ...
        <div className="flex-1 flex flex-col">
          <div className="p-4 flex-1 overflow-auto">
            <div className="text-sm mb-2">User: Hello!</div>
