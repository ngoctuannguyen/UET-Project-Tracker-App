...
// Component- Unit (1 - n)
Component.hasMany(Unit, { foreignKey: 'componentId' });
Unit.belongsTo(Component, { foreignKey: 'componentId' });

// Unit - Employee (1 - n)
Unit.hasMany(Employee, { foreignKey: 'unitId' });
Employee.belongsTo(Unit, { foreignKey: 'unitId' });

// Component- Product (1 - n)
...
// Product - Report (1 - n)
Product.hasMany(Report, { foreignKey: 'productCode', onDelete: 'SET NULL' });
Report.belongsTo(Product, { foreignKey: 'productCode', onDelete: 'SET NULL' });

Component.hasOne(Report, { foreignKey: 'componentCode' });
